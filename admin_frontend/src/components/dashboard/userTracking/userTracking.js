		...
		return (
    		...
    		<div>
			   ...
			   <AreaChart width={580} height={300} data={this.props.revenueByTopCmpnyMonth} syncId="anyId" margin={{top: 5, right: 30, left: 20, bottom: 5}}>
		        ...
		        <BarChart width={1200} height={300} data={this.props.userAnalytics} margin={{top: 20, right: 30, left: 20, bottom: 5}}>
		        	<XAxis dataKey="name">
...
function mapStateToProps(state) {
    return {
    	userAnalytics : state.userTrackingReducer.userAnalytics
    };
}
